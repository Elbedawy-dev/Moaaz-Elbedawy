          ...
          {visibleProjects.map((project) => {
            ...
            return (
              <motion.article
                ...
                className="flex flex-col overflow-hidden rounded-card border border-border bg-surface-1 transition-all duration-300 hover:-translate-y-0.5 hover:border-border-active hover:shadow-card-hover"
              >
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <div className="mt-4 flex flex-wrap gap-1.5">
                    {project.stack.map((tech) => (
                      <span
                        key={tech}
                        className="rounded-full border border-border bg-surface-2 px-2.5 py-0.5 font-mono text-[11px] text-text-secondary"
                      >
                        {tech}
                      </span>
                    ))}
